...
| PROJ-9 | Automatische Werkstattkommunikation (Resend direkt) | Deployed | [PROJ-9](PROJ-9-werkstattkommunikation-n8n.md) | 2026-03-07 |
...
**Phase 2 — Automatisierung (P1):** PROJ-11 → PROJ-8 → PROJ-9 → PROJ-10 → PROJ-12
**Phase 3 — SaaS-Vollausbau (P2):** PROJ-13 → PROJ-14 → PROJ-15
