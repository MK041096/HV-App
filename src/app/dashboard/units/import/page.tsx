            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Sie haben bereits eine Excel- oder CSV-Datei? Laden Sie sie direkt hoch, SMARTCARL erkennt die Spalten automatisch. Oder laden Sie diese Vorlage herunter und füllen Sie sie aus.
                </p>
              </div>
            </div>
