...
const problems = [
  ...
  },
  {
    ...
    title: 'Jede Meldung bindet Ihre Mitarbeiter',
    text: 'Rückfragen, manuelles Einpflegen, Weiterleiten. Ein einziger Schadensfall kostet wertvolle Zeit, jeden Tag, mehrfach.',
  },
  {
