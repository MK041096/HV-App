      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, maxWidth: 860, margin: '0 auto' }}>
          ...
          <div style={{ background: '#FFFFFF', border: '1px solid #E0E0E0', borderRadius: 10, padding: '36px 32px', position: 'relative', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                <span style={{ fontFamily: 'var(--font-dm-sans, sans-serif)', fontSize: 40, fontWeight: 700, color: '#000', lineHeight: 1 }}>0,15 €</span>
          ...
          <div style={{ background: '#FFFFFF', border: '2px solid #C74229', borderRadius: 10, padding: '36px 32px', position: 'relative', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                <span style={{ fontFamily: 'var(--font-dm-sans, sans-serif)', fontSize: 40, fontWeight: 700, color: '#000', lineHeight: 1 }}>0,10 €</span>
                <span style={{ fontFamily: 'var(--font-dm-sans, sans-serif)', fontSize: 13, color: '#555' }}>/ Einheit / Monat</span>
              </div>
              <span style={{ fontFamily: 'var(--font-dm-sans, sans-serif)', fontSize: 13, color: '#555', display: 'block', marginTop: 6 }}>33% Rabatt bei jährlicher Zahlung</span>
            </div>
        ...
        <div style={{ maxWidth: 860, margin: '32px auto 0', background: '#FFFFFF', border: '1px solid #E0E0E0', borderRadius: 10, padding: '28px 32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16 }}>
            <div style={{ background: '#F9F9F9', borderRadius: 8, padding: '16px 20px' }}>
              ...
              <p style={{ fontFamily: 'var(--font-dm-sans, sans-serif)', fontSize: 28, fontWeight: 700, color: '#000', margin: '0 0 2px' }}>{(units * 0.15).toFixed(2).replace('.', ',')} €</p>
            ...
            <div style={{ background: '#FFF5F3', border: '1px solid rgba(199,66,41,0.2)', borderRadius: 8, padding: '16px 20px' }}>
              ...
              <p style={{ fontFamily: 'var(--font-dm-sans, sans-serif)', fontSize: 28, fontWeight: 700, color: '#000', margin: '0 0 2px' }}>{(units * 0.10 * 12).toFixed(2).replace('.', ',')} €</p>
              <p style={{ fontFamily: 'var(--font-dm-sans, sans-serif)', fontSize: 13, color: '#555', margin: 0 }}>pro Jahr (33% gespart)</p>
            </div>
            <div style={{ background: '#F9F9F9', borderRadius: 8, padding: '16px 20px' }}>
