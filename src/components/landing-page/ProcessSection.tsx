                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <p style={{ fontFamily: 'var(--font-dm-sans, sans-serif)', fontSize: 14, lineHeight: 1.65, color: '#FFFFFF', margin: 0, fontWeight: 500 }}>
                          Was Ihre Mitarbeiter früher <strong>viele Stunden</strong> an Telefonaten, E-Mails und Unterlagensuche gekostet hat, liegt jetzt in Sekunden fertig vor ihr.
                        </p>
                      </div>
                    </div>
                  )}
